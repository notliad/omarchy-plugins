...
Item {
  ...
  component BarPanel: PanelWindow {
    ...
    margins {
      top: root.position === "top" ? (root.barHidden ? -root.barSize : 3) : 0
      bottom: root.barHidden && root.position === "bottom" ? -root.barSize : 0
      left: root.vertical ? (root.barHidden && root.position === "left" ? -root.barSize : 0) : 5
      right: root.vertical ? (root.barHidden && root.position === "right" ? -root.barSize : 0) : 5
    }
